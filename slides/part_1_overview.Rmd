---
title: 'An introduction to emulation'
...
## Example 2: A more complex simulator: 2D temperature diffusion

```{r, out.width="40%", echo = FALSE, fig.show = 'hold'}
knitr::include_graphics(c('PastedGraphic-2.png','PastedGraphic-3.png'))
```

## Example 2 continued

The 2D temperature diffusion is based on the following equation:

  $$\frac{\partial T}{\partial t} = \mathscr{D} \nabla^2 T$$
  
We provide the temperature ($T$) at the top, bottom, left and right of a grid, define the diffusivity. 

We then run the simulation for 1 second and record the temperature at the centre of the domain
